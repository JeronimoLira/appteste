...
title = ECube - Cartão de Visitas

# (str) Package name
package.name = appecube

# (str) Package domain (needed for android/ios packaging)
package.domain = org.appecube
...
requirements = python3,kivy,pyjnius>=1.6.1,requests,certifi,urllib3,chardet,idna
...
android.add_src = /home/jlira/projetos/pyjnius
...
android.add_compile_options = "/home/jlira/projetos/appteste/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/other_builds/python3/armeabi-v7a__ndk_target_21/python3/Include/cpython"

# (list) Gradle repositories to add {can be necessary for some android.gradle_dependencies}
# please enclose in double quotes 
# e.g. android.gradle_repositories = "maven { url 'https://repo.spring.io/release' }"
#android.add_gradle_repositories =
android.gradle_settings_file = None
